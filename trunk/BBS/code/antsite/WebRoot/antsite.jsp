	  	...
	  	<table width="100%" height="100%" border="0">
	  		<tr>
	  			<td id="menu" style="width: 15%;display: ">
	  				<iframe src="tree.jsp" width="100%" height="100%" scrolling="auto" style="border: 0"></iframe>
	  			</td>
	  			...
	  			<td id="main" style="width: 85%;display: ">
	  				<iframe src="main.jsp" width="100%" height="100%" scrolling="auto" style="border: 0"></iframe>
	  			</td>
	  		</tr>
	  	</table>
  	</form>
