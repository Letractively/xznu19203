...
import com.c_platform.parsebody.parsebody.scale.ScaleByIm4java;
import com.c_platform.parsebody.parsebody.webparse.common.ClassifyFilter;
...
public class SequenceUtils {
	...
	private double[] getWH(WebContext ctx) {
		...
		double width = Integer.parseInt(ctx.getScreen()[1]);
		double height = Integer.parseInt(ctx.getScreen()[0]);
		wh_temp[0] = width;
		wh_temp[1] = height;
		return wh_temp;
	}
